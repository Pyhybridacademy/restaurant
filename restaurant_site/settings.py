...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-7f=^@7#^7lp-#*4va=77jahhgkj1!76^!g4ax=vb@&bu#-5a=x')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=True, cast=bool)

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'restaurant-ra9l.onrender.com', '.vercel.app']
...
CSRF_TRUSTED_ORIGINS = ['https://restaurant-ra9l.onrender.com']